...
public class ViewDailyOrderAdapter extends RecyclerView.Adapter<ViewDailyOrderAdapter.ViewHolder> {

    private Context context;
    private List<Order> orderList;
    private SimpleDateFormat dateFormat = new SimpleDateFormat("hh:mm aa");

    public ViewDailyOrderAdapter(Context context, List<Order> orderList) {
